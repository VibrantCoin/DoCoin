...
uint256 hashGenesisBlock("0xa60273ac7d3581db1ed2cccaedbb6a9078249351da98a7ce1d3e77836511c363");
...
const string strMessageMagic = "DoCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // DoCoin: 1 days
static const int64 nTargetSpacing = 60; // DoCoin: 1 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal docoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "DoCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x175689f994675ed920145c66c7d0b73d28d54f6da8cca0e1212d2c4d521fe5eb");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1472711977; //epochtime 1472714883
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1211841;

        if (fTestNet)
        {
            block.nTime    = 1471000000;
            block.nNonce   = 683514;
        }
